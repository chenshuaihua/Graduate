...
for i = 1:l
    ...
    std_da5_4 = std(detda5_4);
    std_da6_4 = std(detda6_4);
    std_da7_4 = std(detda7_4);
    std_da8_4 = std(detda8_4);
    std_da9_4 = std(detda9_4);
    std_da10_4 = std(detda10_4);
    std_da11_4 = std(detda11_4);
    std_da12_4 = std(detda12_4);
    std_da13_4 = std(detda13_4);
    std_da14_4 = std(detda14_4);
    std_da15_4 = std(detda15_4);
    std_da16_4 = std(detda16_4);
    std_da17_4 = std(detda17_4);
    std_da18_4 = std(detda18_4);
    std_da19_4 = std(detda19_4);
    std_da20_4 = std(detda20_4);
    std_da21_4 = std(detda21_4);
    std_da22_4 = std(detda22_4);
    std_da23_4 = std(detda23_4);
    std_da24_4 = std(detda24_4);
    std_da25_4 = std(detda25_4);
    std_da26_4 = std(detda26_4);
    std_da27_4 = std(detda27_4);
    std_da28_4 = std(detda28_4);
    std_da29_4 = std(detda29_4);
    std_da30_4 = std(detda30_4);
    
    y1 = SamEnVal(a1,2,0.25*std_da1_4);
    y2 = SamEnVal(a2,2,0.25*std_da2_4);
    y3 = SamEnVal(a3,2,0.25*std_da3_4);
    y4 = SamEnVal(a4,2,0.25*std_da4_4);
    y5 = SamEnVal(a5,2,0.25*std_da5_4);
    y6 = SamEnVal(a6,2,0.25*std_da6_4);
    y7 = SamEnVal(a7,2,0.25*std_da7_4);
    y8 = SamEnVal(a8,2,0.25*std_da8_4);
    y9 = SamEnVal(a9,2,0.25*std_da9_4);
    y10 = SamEnVal(a10,2,0.25*std_da10_4);
    y11 = SamEnVal(a11,2,0.25*std_da11_4);
    y12 = SamEnVal(a12,2,0.25*std_da12_4);
    y13 = SamEnVal(a13,2,0.25*std_da13_4);
    y14 = SamEnVal(a14,2,0.25*std_da14_4);
    y15 = SamEnVal(a15,2,0.25*std_da15_4);
    y16 = SamEnVal(a16,2,0.25*std_da16_4);
    y17 = SamEnVal(a17,2,0.25*std_da17_4);
    y18 = SamEnVal(a18,2,0.25*std_da18_4);
    y19 = SamEnVal(a19,2,0.25*std_da19_4);
    y20 = SamEnVal(a20,2,0.25*std_da20_4);
    y21 = SamEnVal(a21,2,0.25*std_da21_4);
    y22 = SamEnVal(a22,2,0.25*std_da22_4);
    y23 = SamEnVal(a23,2,0.25*std_da23_4);
    y24 = SamEnVal(a24,2,0.25*std_da24_4);
    y25 = SamEnVal(a25,2,0.25*std_da25_4);
    y26 = SamEnVal(a26,2,0.25*std_da26_4);
    y27 = SamEnVal(a27,2,0.25*std_da27_4);
    y28 = SamEnVal(a28,2,0.25*std_da28_4);
    y29 = SamEnVal(a29,2,0.25*std_da29_4);
    y30 = SamEnVal(a30,2,0.25*std_da30_4);

    
    y = [y1;y2;y3;y4;y5;y6;y7;y8;y9;y10;y11;y12;y13;y14;y15;y16;y17;y18;y19;y20;y21;y22;y23;y24;y25;y26;y27;y28;y29;y30];
    
    fid = fopen('E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb01_nor_sampen_d4.txt','at');

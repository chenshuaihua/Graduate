...
path = 'C:\Users\hasee\Desktop\数据1\chb03\nor\';
...
for i = 1:l
    ...
    std_da2_5 = std(detda2_5);
    std_da3_5 = std(detda3_5);
    std_da4_5 = std(detda4_5);
    std_da5_5 = std(detda5_5);
    std_da6_5 = std(detda6_5);
    std_da7_5 = std(detda7_5);
    std_da8_5 = std(detda8_5);
    std_da9_5 = std(detda9_5);
    std_da10_5 = std(detda10_5);
    std_da11_5 = std(detda11_5);
    std_da12_5 = std(detda12_5);
    std_da13_5 = std(detda13_5);
    std_da14_5 = std(detda14_5);
    std_da15_5 = std(detda15_5);
    std_da16_5 = std(detda16_5);
    std_da17_5 = std(detda17_5);
    std_da18_5 = std(detda18_5);
    std_da19_5 = std(detda19_5);
    std_da20_5 = std(detda20_5);
    std_da21_5 = std(detda21_5);
    std_da22_5 = std(detda22_5);
    std_da23_5 = std(detda23_5);
    std_da24_5 = std(detda24_5);
    std_da25_5 = std(detda25_5);
    std_da26_5 = std(detda26_5);
    std_da27_5 = std(detda27_5);
    std_da28_5 = std(detda28_5);
    std_da29_5 = std(detda29_5);
    std_da30_5 = std(detda30_5);
    
    y1 = SamEnVal(a1,2,0.25*std_da1_5);
    y2 = SamEnVal(a2,2,0.25*std_da2_5);
    y3 = SamEnVal(a3,2,0.25*std_da3_5);
    y4 = SamEnVal(a4,2,0.25*std_da4_5);
    y5 = SamEnVal(a5,2,0.25*std_da5_5);
    y6 = SamEnVal(a6,2,0.25*std_da6_5);
    y7 = SamEnVal(a7,2,0.25*std_da7_5);
    y8 = SamEnVal(a8,2,0.25*std_da8_5);
    y9 = SamEnVal(a9,2,0.25*std_da9_5);
    y10 = SamEnVal(a10,2,0.25*std_da10_5);
    y11 = SamEnVal(a11,2,0.25*std_da11_5);
    y12 = SamEnVal(a12,2,0.25*std_da12_5);
    y13 = SamEnVal(a13,2,0.25*std_da13_5);
    y14 = SamEnVal(a14,2,0.25*std_da14_5);
    y15 = SamEnVal(a15,2,0.25*std_da15_5);
    y16 = SamEnVal(a16,2,0.25*std_da16_5);
    y17 = SamEnVal(a17,2,0.25*std_da17_5);
    y18 = SamEnVal(a18,2,0.25*std_da18_5);
    y19 = SamEnVal(a19,2,0.25*std_da19_5);
    y20 = SamEnVal(a20,2,0.25*std_da20_5);
    y21 = SamEnVal(a21,2,0.25*std_da21_5);
    y22 = SamEnVal(a22,2,0.25*std_da22_5);
    y23 = SamEnVal(a23,2,0.25*std_da23_5);
    y24 = SamEnVal(a24,2,0.25*std_da24_5);
    y25 = SamEnVal(a25,2,0.25*std_da25_5);
    y26 = SamEnVal(a26,2,0.25*std_da26_5);
    y27 = SamEnVal(a27,2,0.25*std_da27_5);
    y28 = SamEnVal(a28,2,0.25*std_da28_5);
    y29 = SamEnVal(a29,2,0.25*std_da29_5);
    y30 = SamEnVal(a30,2,0.25*std_da30_5);

    
    y = [y1;y2;y3;y4;y5;y6;y7;y8;y9;y10;y11;y12;y13;y14;y15;y16;y17;y18;y19;y20;y21;y22;y23;y24;y25;y26;y27;y28;y29;y30];
    
    fid = fopen('E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb03_nor_sampen_d5.txt','at');

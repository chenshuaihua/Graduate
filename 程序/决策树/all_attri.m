...
%%%%%%%读取数据
xm = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen.txt");
xn = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\E_sampen.txt");

xo = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d1.txt");
xp = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\E_sampen_d1.txt");

xq = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d2.txt");
xr = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\E_sampen_d2.txt");

xs = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d3.txt");
xt = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\E_sampen_d3.txt");




%%%%%%%设置数据标签
x = [xa xc xe xg xi xk xm xo xq xs;xb xd xf xh xj xl xn xp xr xt];
A = zeros(400,1);
B = ones(400,1);
label = [A;B];
...
for i = 1:5
    ...
    plot(label_test,'bo');
    title("DT对DE两组的分类结果（根据原始脑电信号及CD1-CD5的标准差）")

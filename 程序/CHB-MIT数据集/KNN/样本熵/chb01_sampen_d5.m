...
%%%%%读取数据
x1 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb01_nor_sampen_d5.txt");
x2 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb01_epil_sampen_d5.txt");
...
%     plot(label_test,'bo');
%     title("KNN对chb01的分类结果（根据CD5的样本熵）")

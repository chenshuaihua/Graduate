...
for i = 1:l
    ...
    yd1 = SamEnVal(detda1_2,2,0.25*std_da1_2);
    yd2 = SamEnVal(detda2_2,2,0.25*std_da2_2);
    yd3 = SamEnVal(detda3_2,2,0.25*std_da3_2);
    yd4 = SamEnVal(detda4_2,2,0.25*std_da4_2);
    
    y = [yd1;yd2;yd3;yd4];
    fid = fopen('E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d2.txt','at');

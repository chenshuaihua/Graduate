...
for i = 1:l
    ...
    std_da5_1 = std(detda5_1);
    std_da6_1 = std(detda6_1);
    std_da7_1 = std(detda7_1);
    std_da8_1 = std(detda8_1);
    std_da9_1 = std(detda9_1);
    std_da10_1 = std(detda10_1);
    std_da11_1 = std(detda11_1);
    std_da12_1 = std(detda12_1);
    std_da13_1 = std(detda13_1);
    std_da14_1 = std(detda14_1);
    std_da15_1 = std(detda15_1);
    std_da16_1 = std(detda16_1);
    std_da17_1 = std(detda17_1);
    std_da18_1 = std(detda18_1);
    std_da19_1 = std(detda19_1);
    std_da20_1 = std(detda20_1);
    std_da21_1 = std(detda21_1);
    std_da22_1 = std(detda22_1);
    std_da23_1 = std(detda23_1);
    std_da24_1 = std(detda24_1);
    std_da25_1 = std(detda25_1);
    std_da26_1 = std(detda26_1);
    std_da27_1 = std(detda27_1);
    std_da28_1 = std(detda28_1);
    std_da29_1 = std(detda29_1);
    std_da30_1 = std(detda30_1);
    
    y1 = SamEnVal(a1,2,0.25*std_da1_1);
    y2 = SamEnVal(a2,2,0.25*std_da2_1);
    y3 = SamEnVal(a3,2,0.25*std_da3_1);
    y4 = SamEnVal(a4,2,0.25*std_da4_1);
    y5 = SamEnVal(a5,2,0.25*std_da5_1);
    y6 = SamEnVal(a6,2,0.25*std_da6_1);
    y7 = SamEnVal(a7,2,0.25*std_da7_1);
    y8 = SamEnVal(a8,2,0.25*std_da8_1);
    y9 = SamEnVal(a9,2,0.25*std_da9_1);
    y10 = SamEnVal(a10,2,0.25*std_da10_1);
    y11 = SamEnVal(a11,2,0.25*std_da11_1);
    y12 = SamEnVal(a12,2,0.25*std_da12_1);
    y13 = SamEnVal(a13,2,0.25*std_da13_1);
    y14 = SamEnVal(a14,2,0.25*std_da14_1);
    y15 = SamEnVal(a15,2,0.25*std_da15_1);
    y16 = SamEnVal(a16,2,0.25*std_da16_1);
    y17 = SamEnVal(a17,2,0.25*std_da17_1);
    y18 = SamEnVal(a18,2,0.25*std_da18_1);
    y19 = SamEnVal(a19,2,0.25*std_da19_1);
    y20 = SamEnVal(a20,2,0.25*std_da20_1);
    y21 = SamEnVal(a21,2,0.25*std_da21_1);
    y22 = SamEnVal(a22,2,0.25*std_da22_1);
    y23 = SamEnVal(a23,2,0.25*std_da23_1);
    y24 = SamEnVal(a24,2,0.25*std_da24_1);
    y25 = SamEnVal(a25,2,0.25*std_da25_1);
    y26 = SamEnVal(a26,2,0.25*std_da26_1);
    y27 = SamEnVal(a27,2,0.25*std_da27_1);
    y28 = SamEnVal(a28,2,0.25*std_da28_1);
    y29 = SamEnVal(a29,2,0.25*std_da29_1);
    y30 = SamEnVal(a30,2,0.25*std_da30_1);

    
    y = [y1;y2;y3;y4;y5;y6;y7;y8;y9;y10;y11;y12;y13;y14;y15;y16;y17;y18;y19;y20;y21;y22;y23;y24;y25;y26;y27;y28;y29;y30];
    
    fid = fopen('E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb03_nor_sampen_d1.txt','at');

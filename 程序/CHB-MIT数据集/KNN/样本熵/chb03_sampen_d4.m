...
x1 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb03_nor_sampen_d4.txt");
x2 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb03_epil_sampen_d4.txt");
...
%     plot(label_test,'bo');
%     title("KNN对chb03的分类结果（根据CD4的样本熵）")
end

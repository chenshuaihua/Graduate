...
#种类，特征向量
names = ['class','AE_sampen','AE_sampen_d1','AE_sampen_d2','AE_sampen_d3']

data = pd.read_csv(r'E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\stacking\样本熵\AE_sampen_after_norm.csv',header=None,names=names)
...
models = [
    SVC(C=16,kernel='rbf',degree=3,gamma=22.6274,coef0=0.0,shrinking=True,probability=False,tol=0.001),

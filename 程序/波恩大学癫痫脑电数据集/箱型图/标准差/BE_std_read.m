...
x1 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\B_biaozhuncha.txt");
y1 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\E_biaozhuncha.txt");

x2 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\B_biaozhuncha_d1.txt");
y2 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\E_biaozhuncha_d1.txt");

x3 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\B_biaozhuncha_d2.txt");
y3 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\E_biaozhuncha_d2.txt");

x4 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\B_biaozhuncha_d3.txt");
y4 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\E_biaozhuncha_d3.txt");

x5 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\B_biaozhuncha_d4.txt");
y5 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\E_biaozhuncha_d4.txt");

x6 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\标准差\B_biaozhuncha_d5.txt");

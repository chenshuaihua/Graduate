...
x2 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb01_epil_sampen.txt");
...
for i = 1:5
   ...
   %view(model,'Mode','graph');
    ...
    fid = fopen('E:\大学\大四学年（2019-2020）\下学期\毕设\结果\CHB-MIT数据集\DT分类\样本熵\test2.txt','at');
...
%     plot(label_test,'bo');
%     title("DT对chb01的分类结果（根据chb01原始脑电信号的样本熵）")
end

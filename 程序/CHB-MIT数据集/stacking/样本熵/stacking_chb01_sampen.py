...
#种类，特征向量
names = ['class','chb01_sampen_d3','chb01_sampen_d4','chb01_sampen_d5']

data = pd.read_csv(r'E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\stacking\样本熵\chb01_sampen.csv',header=None,names=names)
...
models = [
    SVC(C=2.8284,kernel='rbf',degree=3,gamma=32,coef0=0.0,shrinking=True,probability=False,tol=0.001),

...
figure
subplot(2,3,1)
boxplot([x1,y1],{'A组脑电信号','E组脑电信号'})
xlabel("(a)EEG")
ylabel("标准差")

subplot(2,3,2)
boxplot([x2,y2],{'A组脑电信号','E组脑电信号'})
xlabel("(b)CD1")
ylabel("标准差")

subplot(2,3,3)
boxplot([x3,y3],{'A组脑电信号','E组脑电信号'})
xlabel("(c)CD2")
ylabel("标准差")

subplot(2,3,4)
boxplot([x4,y4],{'A组脑电信号','E组脑电信号'})
xlabel("(d)CD3")
ylabel("标准差")

subplot(2,3,5)
boxplot([x5,y5],{'A组脑电信号','E组脑电信号'})
xlabel("(e)CD4")
ylabel("标准差")

subplot(2,3,6)
boxplot([x6,y6],{'A组脑电信号','E组脑电信号'})
xlabel("(f)CD5")
ylabel("标准差")

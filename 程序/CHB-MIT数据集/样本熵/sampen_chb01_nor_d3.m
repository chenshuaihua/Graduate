...
for i = 1:l
    ...
    y1 = SamEnVal(a1,2,0.25*std_da1_3);
    y2 = SamEnVal(a2,2,0.25*std_da2_3);
    y3 = SamEnVal(a3,2,0.25*std_da3_3);
    y4 = SamEnVal(a4,2,0.25*std_da4_3);
    y5 = SamEnVal(a5,2,0.25*std_da5_3);
    y6 = SamEnVal(a6,2,0.25*std_da6_3);
    y7 = SamEnVal(a7,2,0.25*std_da7_3);
    y8 = SamEnVal(a8,2,0.25*std_da8_3);
    y9 = SamEnVal(a9,2,0.25*std_da9_3);
    y10 = SamEnVal(a10,2,0.25*std_da10_3);
    y11 = SamEnVal(a11,2,0.25*std_da11_3);
    y12 = SamEnVal(a12,2,0.25*std_da12_3);
    y13 = SamEnVal(a13,2,0.25*std_da13_3);
    y14 = SamEnVal(a14,2,0.25*std_da14_3);
    y15 = SamEnVal(a15,2,0.25*std_da15_3);
    y16 = SamEnVal(a16,2,0.25*std_da16_3);
    y17 = SamEnVal(a17,2,0.25*std_da17_3);
    y18 = SamEnVal(a18,2,0.25*std_da18_3);
    y19 = SamEnVal(a19,2,0.25*std_da19_3);
    y20 = SamEnVal(a20,2,0.25*std_da20_3);
    y21 = SamEnVal(a21,2,0.25*std_da21_3);
    y22 = SamEnVal(a22,2,0.25*std_da22_3);
    y23 = SamEnVal(a23,2,0.25*std_da23_3);
    y24 = SamEnVal(a24,2,0.25*std_da24_3);
    y25 = SamEnVal(a25,2,0.25*std_da25_3);
    y26 = SamEnVal(a26,2,0.25*std_da26_3);
    y27 = SamEnVal(a27,2,0.25*std_da27_3);
    y28 = SamEnVal(a28,2,0.25*std_da28_3);
    y29 = SamEnVal(a29,2,0.25*std_da29_3);
    y30 = SamEnVal(a30,2,0.25*std_da30_3);

    
    y = [y1;y2;y3;y4;y5;y6;y7;y8;y9;y10;y11;y12;y13;y14;y15;y16;y17;y18;y19;y20;y21;y22;y23;y24;y25;y26;y27;y28;y29;y30];
    
    fid = fopen('E:\大学\大四学年（2019-2020）\下学期\毕设\数据\CHB-MIT数据集\样本熵\chb01_nor_sampen_d3.txt','at');

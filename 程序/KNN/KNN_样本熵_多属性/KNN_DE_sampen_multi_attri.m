...
x3 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d1.txt");
x4 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\E_sampen_d1.txt");

x5 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d2.txt");
x6 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\E_sampen_d2.txt");

x7 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d3.txt");
x8 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\E_sampen_d3.txt");

x9 = load("E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\样本熵\D_sampen_d4.txt");

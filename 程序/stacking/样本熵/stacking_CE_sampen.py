...
#种类，特征向量
names = ['class','CE_sampen','CE_sampen_d1','CE_sampen_d2','CE_sampen_d3']

data = pd.read_csv(r'E:\大学\大四学年（2019-2020）\下学期\毕设\数据\1\stacking\样本熵\CE_sampen_after_norm.csv',header=None,names=names)
